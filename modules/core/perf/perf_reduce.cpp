            ...
            )
{
    ...
    Mat src(sz, matType);
    Mat vec(1, sz.width, ddepth == CV_DEPTH_UNSPECIFIED ? matType : CV_MAKETYPE(ddepth, 1));
            ...
            )
{
    ...
    Mat src(sz, matType);
    Mat vec(sz.height, 1, ddepth == CV_DEPTH_UNSPECIFIED ? matType : CV_MAKETYPE(ddepth, 1));
